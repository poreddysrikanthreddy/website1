    ...
    <section className="home-banner py-20 bg-[linear-gradient(to_bottom,#c7ecff_0,#f9efff_100%)] min-h-screen relative
      ...
      <div className="container max-w-6xl mx-auto relative z-10 px-2">
        <div className="grid grid-cols-[1fr_1fr] items-center gap-5 min-h-[calc(100vh-160px)]">
          <div>
            <h2 className='text-blue font-bold font-poppins lg:text-[52px] text-4xl lg:leading-[60px] leading-10 lg:mb-8 mb-6'> Innovate with <br /> Composable  <br /> Commerce</h2>
            <p className='lg:text-xl text-base leading-7 mb-8'>
            Accelerate innovation to empower your brand with technology to excel.
            </p>
            <p>
              <Link to="#" className="btn btn-pink">Explore more</Link>
            </p>
          </div>
