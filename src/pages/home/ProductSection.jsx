...
import prod1 from "../../assets/img/home/creativeweb.jpg";
import prod2 from "../../assets/img/home/prod-2.jpg";
import prod3 from "../../assets/img/creativeWorks/innovative.webp";
import prod4 from "../../assets/img/creativeWorks/drcommence.webp";

export default function ProductSection() {
  return (
    <section
      className="home-product lg:py-12 py-8 relative before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-[380px]
       before:z-[-1]"
    >
      <div className="container max-w-6xl mx-auto px-2">
        ...
        <div className="grid lg:grid-cols-[1fr_2fr] grid-cols gap-6 mb-6">
          ...
          <div>
            ...
            <h5 className="text-blue font-poppins font-semibold text-2xl mb-2">
              <a href="#e">Dr.Commerce</a>
            </h5>
            <p>eCommenrce ecosystem</p>
          </div>
        </div>
